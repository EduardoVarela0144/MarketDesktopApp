...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Principal_Icon.png"))); // NOI18N
        ...
        bg.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 310, 520));
        ...
        favicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Logo_Sesion.png"))); // NOI18N
        favicon.setText(" SISTEMA DE ADMINISTRACIÓN");
        ...
        loginBtn.setBackground(new java.awt.Color(47, 45, 46));

        loginBtnTxt.setBackground(new java.awt.Color(47, 45, 46));
    ...
    private void loginBtnTxtMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseEntered
        loginBtn.setBackground(new Color(41, 112, 202));
    }//GEN-LAST:event_loginBtnTxtMouseEntered

    private void loginBtnTxtMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseExited
        loginBtn.setBackground(new Color(47,45,46));
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
       ...
       if(ausuarios.exists())
        {
            Bar_Login jdl = new Bar_Login(null, true);
            jdl.setVisible(true);
        ...
        // abrir jdialog para crear usuario
          Agregar_Nuevo_Usuario nu = new Agregar_Nuevo_Usuario(this, true);
           nu.iniciar(this);
           nu.setVisible(true);
     ...
     public static String buscarUsuario(String u, String p)
    {
      String rol="";
      for(Usuario usu: lusuarios)
      {
         if(usu.getUsuario().compareTo(u)==0 && usu.getPassword().compareTo(Encriptar.convertirSHA256(p))==0)
         {
             rol= usu.getRol();
             break;
         }
