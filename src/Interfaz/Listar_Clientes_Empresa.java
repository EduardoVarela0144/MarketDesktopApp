...
public class Listar_Clientes_Empresa extends javax.swing.JPanel {

    
    public Listar_Clientes_Empresa() {
        initComponents();
        addRowToJTable();
    }
...
model.addRow(rowData);
 ...
 public void eliminar(){
    ...
    private void initComponents() {
        ...
        Title.setText("Lista de productos");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ordenar Por:", "ID", "Nombre", "Ubicación" }));
